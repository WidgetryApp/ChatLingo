package net.dobreguy.uniteslator.util;

import com.mojang.blaze3d.systems.RenderSystem;
import net.dobreguy.uniteslator.UniteslatorClient;
import net.dobreguy.uniteslator.mixin.DrawContextAccessor;
...
public class RenderBubble {
    ...
    private static final Identifier BACKGROUND = new Identifier("uniteslator:textures/gui/background.png");
    ...
    public static void renderBubble(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, TextRenderer textRenderer, EntityRenderDispatcher entityRenderDispatcher,
        ...
        matrixStack.translate(0.0D, playerHeight + 0.9F + (backgroundHeight > 5 ? 0.1F : 0.0F) + UniteslatorClient.CONFIG.chatHeight, 0.0D);
        ...
        RenderSystem.setShaderColor(UniteslatorClient.CONFIG.backgroundRed, UniteslatorClient.CONFIG.backgroundGreen, UniteslatorClient.CONFIG.backgroundBlue, UniteslatorClient.CONFIG.backgroundOpacity);
        ...
        for (int u = textList.size(); u > 0; u--) {
            ...
            textRenderer.draw(textList.get(u - 1), h, ((float) textList.size() + (u - textList.size()) * 9), UniteslatorClient.CONFIG.chatColor, false, matrix4f, vertexConsumerProvider,
